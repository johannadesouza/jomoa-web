...
-- Allmänna tips (phase = null) - 5 tips
  ('770e8400-e29b-41d4-a716-446655440024', 'Konsistens över perfektion', 'Det är bättre att träna regelbundet med måttlig intensitet än att träna hårt ibland och sedan inte alls.', 'training', NULL, 'general', true, now()),
  ('770e8400-e29b-41d4-a716-446655440025', 'Återhämtning är träning', 'Återhämtning är lika viktigt som träningen själv. Se till att få tillräckligt med sömn och vila.', 'mindset', NULL, 'general', true, now()),
  ('770e8400-e29b-41d4-a716-446655440026', 'Hydrering dagligen', 'Drick vatten regelbundet genom dagen, inte bara när du tränar. Det hjälper kroppen fungera optimalt.', 'nutrition', NULL, 'general', true, now()),
  ('770e8400-e29b-41d4-a716-446655440027', 'Varje dag är en ny chans', 'Om du missade träningen igår, det är okej. Varje dag är en ny chans att göra rätt val.', 'mindset', NULL, 'general', true, now()),
  ('770e8400-e29b-41d4-a716-446655440028', 'Lyssna på kroppen', 'Kroppen ger signaler. Lär dig känna igen när du behöver vila och när du kan pusha dig själv.', 'training', NULL, 'general', true, now())
ON CONFLICT (id) DO NOTHING;
