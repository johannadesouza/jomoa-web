    ...
    <div className="space-y-6">
      ...
      {notifications.length === 0 ? (
        <EmptyState
          ...
          description="När det händer något viktigt kommer du att få notifikationer här."
        />
      ) : (
        <div className="space-y-4">
          ...
          {unreadNotifications.length > 0 && (
            <div className="space-y-3">
              <h2 className="text-sm font-medium text-[#5A6B5D] flex items-center gap-2">
          ...
          {readNotifications.length > 0 && (
            <div className="space-y-3">
              <h2 className="text-sm font-medium text-[#5A6B5D]/70 flex items-center gap-2">
