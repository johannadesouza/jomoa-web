...
// ─── Adaptation-text (återanvänd logik från AdaptationInsightCard) ────────────
...
function getAdaptHeadline(volumeModifier: number, appliedRules: string[], suggestRecovery: boolean): string {
...
export function MorningRoutineModal({
  ...
  const adaptHeadline = getAdaptHeadline(
